...
public class AdaptadorRecyclerView extends RecyclerView.Adapter<AdaptadorRecyclerView.ViewHolderDatos>{
    ...
    public AdaptadorRecyclerView(List<Ticket> listaTickets) {
    ...
    public static class ViewHolderDatos extends RecyclerView.ViewHolder {
        ...
        String DescripcionTicket, UrlImagen, EstadoTicket, SocioTicket;
        int idTicket;
        Button BtnMas;
        ...
        public ViewHolderDatos(@NonNull View itemView) {
            ...
            BtnMas.setOnClickListener( new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(itemView.getContext(),DetalleTicketsCliente.class);
                    ...
                    intent.putExtra("socio",SocioTicket);
        ...
        public void asignarDatos(Ticket ticket) {
            ...
            SocioTicket = ticket.getNombreSocio();
        }
    }
}
